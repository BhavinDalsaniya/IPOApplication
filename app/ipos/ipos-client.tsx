...
export default function IPOsClient({ initialIpos, initialPagination }: IPOsClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-violet-50/20" style={{ fontSize: '80%' }}>
      {/* Header */}
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex-1 max-w-xl flex items-center gap-3">
              ...
              <button
                ...
                disabled={refreshing}
                className="px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition disabled:opacity-50 shadow-lg shadow-blue-500/30 flex items-center gap-2"
