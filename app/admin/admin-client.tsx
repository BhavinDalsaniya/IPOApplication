...
export default function AdminClient({ initialIpos }: AdminClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Auto-assign Sr. No for new IPOs
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <h2 className="text-2xl font-bold text-slate-900">
            IPOs ({filteredIpos.length} {searchQuery && `of ${ipos.length}`})
          </h2>
          <button
        ...
        {showForm && (
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
            ...
            <div className="mb-4 p-3 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-600">
              ...
              {!editingId && <span className="block mt-1">Sr. No will be auto-generated.</span>}
            </div>
